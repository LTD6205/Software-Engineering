...
describe('roles helpers', () => {
  describe('roleColorOf', () => {
    it('returns the matching colour for each known role', () => {
      ...
      expect(roleColorOf('organizer')).toBe(ROLE_COLOR.organizer)
