...
const config: Record<Status, { bg: string; color: string; en: string; vi: string }> = {
  // Status: pending=yellow, in progress=blue, completed=green, overdue=red.
  pending:     { bg: '#2d2a1a', color: '#fbbf24', en: 'Pending',     vi: 'Chờ xử lý' },
  in_progress: { bg: '#1e2d4a', color: '#60a5fa', en: 'In Progress', vi: 'Đang làm' },
  completed:   { bg: '#1a3320', color: '#22c55e', en: 'Completed',   vi: 'Hoàn thành' },
  overdue:     { bg: '#3a1a1a', color: '#f87171', en: 'Overdue',     vi: 'Quá hạn' },
  // Priority labels.
  low:         { bg: '#1e3a2e', color: '#34d399', en: 'Low',         vi: 'Thấp' },
